...
- The safe source inventory records one assessment file and 135 mixed-format submission files.
- Identity-bearing filenames exist in the raw submission tree. Raw names, answer content, identity maps, and private hashes are not tracked here.
- Filename-prefix analysis yields 43 provisional submission groups, not an approved anonymous roster.
- Five groups have 3, 5, or 6 source pages rather than the expected four and require page-level scope review after anonymization.
...
## Gates before a development model run

1. Approve the reference solution and rubric.
2. Complete page-level anonymization, privacy, blindness, and answer-preservation review.
3. Freeze a development/held-out split and record development question-level gold.
4. Freeze and audit matched M1, T1, and G1 packets, including lineage.
5. Pin the actual model/provider configuration and record explicit development-run approval.
