...
| Candidate | `codex_cli / codex` | `gpt-5.6-sol` | `text-only` | `G1-codex-v5_2_r2-dev-r2` | `passed` |

## Aggregate metrics

| Metric | Baseline | Candidate | Candidate - baseline |
| --- | ---: | ---: | ---: |
| `exact_agreement` | 0.8900 | 0.8733 | -0.0167 |
| `subquestion_mae` | 0.5100 | 0.5367 | 0.0267 |
| `mean_signed_error` | 0.1567 | 0.0033 | -0.1533 |
| `total_score_mae` | 2.5333 | 3.0333 | 0.5000 |
| `within_1_point_rate` | 0.5000 | 0.5000 | 0.0000 |
| `severe_error_rate` | 0.4667 | 0.4000 | -0.0667 |
| `macro_accuracy` | 0.8900 | 0.8733 | -0.0167 |
...
| `Q2a` | 30 | 0.7667 | 0.6333 | -0.1333 | 1.5333 | 1.4333 | -0.1000 |
| `Q2b` | 30 | 0.8000 | 0.7667 | -0.0333 | 0.7333 | 0.8333 | 0.1000 |
| `Q3` | 30 | 0.9333 | 0.9667 | 0.0333 | 0.1667 | 0.0667 | -0.1000 |
| `Q3bonus` | 30 | 0.9333 | 0.9333 | 0.0000 | 0.6667 | 0.6667 | 0.0000 |
| `Q4` | 30 | 0.5333 | 0.5000 | -0.0333 | 1.6667 | 2.0333 | 0.3667 |
