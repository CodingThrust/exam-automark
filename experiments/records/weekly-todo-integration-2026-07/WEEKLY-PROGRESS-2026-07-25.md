...
| TASK5 | GitHub Actions CI quality gate | Project infrastructure | `running` | Draft PR #35 adds guarded core/Physics suites plus explicit privacy, held-out, sealed-test, and research-provenance checks; local equivalents passed | Pass all three GitHub checks, require their exact contexts on `main`, then merge PR #35 | Bilingual settlement draft links PR #35; not posted |
