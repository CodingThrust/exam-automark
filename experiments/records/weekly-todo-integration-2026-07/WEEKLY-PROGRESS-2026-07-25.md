...
| TASK5 | GitHub Actions CI quality gate | Project infrastructure | `running` | Draft PR #35 passes all three Ubuntu checks; exact contexts are required on `main` and bound to GitHub Actions; approvals remain 0 | Merge PR #35, then verify the post-merge `main` push run | Bilingual settlement draft links PR #35; not posted |
